...
class AnalyzerService:
    ...
    def __init__(self, timeout: int = None, headless: bool = None):
    ...
    async def _is_product_page(self, url: str) -> bool:
        ...
        try:
            ...
            logger.info(f"[PRODUCT] Validation for {url[:80]}: title={title_found}, desc={description_found}, price={price_found}, cart={add_to_cart_found}, url_pattern={has_product_url_pattern}, indicators={indicators}/4")
