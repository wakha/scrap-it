...
class BotDetector:
    ...
    def detect_bot_protection(self, page_source: str, url: str) -> Dict[str, any]:
        ...
        """
        detections = {"has_protection": False, "protection_types": [], "confidence": "low", "details": []}
    ...
    def _detect_datadome(self, page_source: str) -> bool:
        ...
        datadome_patterns = [r"datadome", r"dd_cookie", r"DataDome"]
    ...
    def _detect_perimeterx(self, page_source: str) -> bool:
        ...
        px_patterns = [r"perimeterx", r"_px\d*", r"PerimeterX"]
